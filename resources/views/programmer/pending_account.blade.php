                    ...
                    <tr>
                        ...
                        <td>
                          <form action="{{ route('programmer.update_status', ['id' => $datas->id]) }}" method="post">
                            ...
                            <br>
                            <input type="radio" id="ceo" name="type" value="ceo" required>
                            <label for="ceo">CEO</label><br>
                            <input type="radio" id="coceo" name="type" value="coceo">
                            <label for="coceo">Co-CEO</label><br>
                            <input type="radio" id="activator" name="type" value="activator">
                            <label for="activator">Activator</label><br>
                            <input type="radio" id="headadmin" name="type" value="headadmin">
                            <label for="headadmin">Head Admin</label><br>
